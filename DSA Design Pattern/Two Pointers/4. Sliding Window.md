...
## 4. The Expand & Shrink Decision Rule 🧠

```text
========================================================================
EXPAND (Advance Right):
Always move `right` forward on each iteration to add elements into the window.

SHRINK (Advance Left):
When a condition triggers (e.g., window valid for minimization, or invalid for uniqueness),
move `left` forward to squeeze the window.
========================================================================
```
